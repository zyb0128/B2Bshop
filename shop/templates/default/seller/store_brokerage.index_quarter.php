...
<form method="get" action="index.php" target="_self">
	<table class="search-form">
		...
		<input type="hidden" name="op" value="index_quarter" />
		<input type="hidden" name="submit" value="ok">
		<input type="hidden" name="pay_t" value="3">  
		<tr>
			<td class="tr">
				<div class="fr">
				...
				<div class="fr">
					...
					<div class="fl" style="margin-right:3px;">
						<select name="pay_quarter" class="querySelect">
							<option value="">全部季度</option>
							<option value="1"  <?php echo $output['search_arr']['pay_quarter']=='1'?'selected':''; ?>>第一季度</option>
							<option value="2"  <?php echo $output['search_arr']['pay_quarter']=='2'?'selected':''; ?>>第二季度</option>
							<option value="3"  <?php echo $output['search_arr']['pay_quarter']=='3'?'selected':''; ?>>第三季度</option>
							<option value="4"  <?php echo $output['search_arr']['pay_quarter']=='4'?'selected':''; ?>>第四季度</option>
						</select>
					</div>
				</div>
			</td>
...
<table class="ncsc-default-table">
	...
	<tbody>
		...
		<tr class="bd-line">
			...
			<td>第<?php echo $val['quarter']; ?>季度</td>
