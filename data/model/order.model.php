...
class orderModel extends Model {
	...
	/**
	 * [getOrderBuyerInfo 获取买家VIP信息]
	 * @param  [type] $buyerId [买家]
	 * @param  [type] $sellerId [卖家]
	 * @return [type]          [description]
	 */
	public function getOrderBuyerInfo($buyerId,$sellerId){
		$result = Model('member_seller')->getMemberSellerId($buyerId,$sellerId);
		$vip = Model('member_vip') -> getMemberVip(array('vip_level_seller_id'=>$sellerId,'id'=>$result['vip_id']));
		// var_dump($vip);exit;
		return $vip ;
	}
}
